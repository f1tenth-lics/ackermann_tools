...
protected:
  ...
  rclcpp::Subscription<ackermann_msgs::msg::AckermannDrive>::SharedPtr ref_subscriber_unstamped_ = nullptr;
  realtime_tools::RealtimeBuffer<std::shared_ptr<ControllerAckermannReferenceMsg>> input_ref_;
...
private:
  ...
  void reference_callback_unstamped(const std::shared_ptr<ackermann_msgs::msg::AckermannDrive> msg);
};
